...
PID pid(0.27, 0.001, 0.01, 500);
//PID pid(0.1, 0.000, 0.0, 200); //0.6, 0.01, 0.6, 200
PID pid2(0.001, 0.001 , 1.4, 200);
...
void processSerial1(String line) {
  float dista, angl;
  int parsed = sscanf(line.c_str(), "%f %f", &dista, &angl);
  if (parsed == 2) {
    dribbler_distance = dista;
   ...
   // Serial.println(dribbler_angle);
    ...
    ball_captured = (dribbler_distance <= 30 && dribbler_angle == 0);
  }
}
